...
void printGamerOver(){
  ...
  printf( "  \\_____/_/    \\_\\_|  |_|______|  \\____/   \\/   |______|_|  \\_\\" COLOR_RESET "\n");
  printf(COLOR_RED "\n\nVocê atingiu a cota máxima de fails ou de lixo!!" COLOR_RESET "\n\n");
}
...
printf("    ##      #      #   ##     ##   		## ##   ## ##   ##  ##    ## ##\n");
printf("    ##       ######    #########   		####     ####   ##  ##     ####" COLOR_RESET "\n");
printf( COLOR_RED "\n\nParabéns, você ganhou o jogo!!" COLOR_RESET "\n\n");
}
